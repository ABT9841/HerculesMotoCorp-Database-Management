-- 1. Create the MotorsCertification database
...
-- Insert records in customers table with corrected salesRepEmployeeNumber
...
-- Insert records in orders table with corrected customerNumber references
INSERT INTO orders VALUES
(10100,'2003-01-06','2003-01-13','2003-01-10','Shipped',NULL,103),
(10101,'2003-01-09','2003-01-18','2003-01-11','Shipped','Check on availability.',128),
(10102,'2003-01-10','2003-01-18','2003-01-14','Shipped',NULL,119),
(10103,'2003-01-29','2003-02-07','2003-02-02','Shipped',NULL,121),
(10104,'2003-01-31','2003-02-09','2003-02-01','Shipped',NULL,141),
(10105,'2003-02-11','2003-02-21','2003-02-12','Shipped',NULL,145),
(10106,'2003-02-17','2003-02-24','2003-02-21','Shipped',NULL,129),
(10107,'2003-02-24','2003-03-03','2003-02-26','Shipped','Difficult to negotiate with customer. We need more marketing materials',131),
(10108,'2003-03-03','2003-03-12','2003-03-08','Shipped',NULL,144),
(10109,'2003-03-10','2003-03-19','2003-03-11','Shipped','Customer requested that FedEx Ground is used for this shipping',157),
(10110,'2003-03-18','2003-03-24','2003-03-20','Shipped',NULL,112),
(10111,'2003-03-25','2003-03-31','2003-03-30','Shipped',NULL,129),
(10112,'2003-03-24','2003-04-03','2003-03-29','Shipped','Customer requested that ad materials (such as posters, pamphlets) be included in the shipment',124),
(10113,'2003-03-26','2003-04-02','2003-03-27','Shipped',NULL,125),
(10114,'2003-04-01','2003-04-07','2003-04-02','Shipped',NULL,148),
(10115,'2003-04-04','2003-04-12','2003-04-07','Shipped',NULL,167),
(10116,'2003-04-11','2003-04-19','2003-04-13','Shipped',NULL,166),
(10117,'2003-04-16','2003-04-24','2003-04-17','Shipped',NULL,146),
(10118,'2003-04-21','2003-04-29','2003-04-26','Shipped','Customer has worked with some of our vendors in the past and is aware of their MSRP',151),
(10119,'2003-04-28','2003-05-05','2003-05-02','Shipped',NULL,161);
...
INSERT INTO orderdetails VALUES
    ...
    (10101,'S10_4962',50,55.09,2),
    (10102,'S12_1666',22,75.46,4),
    (10103,'S18_1342',49,35.29,1),
    (10104,'S18_1367',25,108.06,4),
    (10105,'S18_1097',26,167.06,1),
    (10106,'S12_3148',45,32.53,3),
    (10107,'S12_3380',46,44.35,2),
    (10108,'S18_1129',39,95.55,2),
    (10109,'S12_3990',41,43.13,1),
    (10111,'S12_4473',42,119.67,4),
    (10112,'S12_4675',27,121.64,8),
...
INSERT INTO payments VALUES
    ...
    (114,'OM314933','2004-12-18',1676.14),
    (119,'BO864823','2004-12-17',14191.12),
    (121,'HQ55022','2003-06-06',32641.98),
    (124,'ND748579','2004-08-20',33347.88),
    (125,'GG31455','2003-05-20',45864.03),
    (128,'MA765515','2004-12-15',82261.22),
    (129,'NP603840','2003-05-31',7565.08),
    (131,'NR27552','2004-03-10',44894.74),
    (141,'DB933704','2004-11-14',19501.82),
    (144,'LN373447','2004-08-08',47924.19),
    (145,'NG94694','2005-02-22',49523.67),
    (146,'DB889831','2003-02-16',50218.95),
    (148,'FD317790','2003-10-28',1491.38),
    (151,'KI831359','2004-11-04',17876.32),
    (157,'MA302151','2004-11-28',34638.14),
    (161,'AE215433','2005-03-05',101244.59),
    (166,'BG255406','2004-08-28',85410.87),
    (167,'CQ287967','2003-04-11',11044.30);
...
-- STEP 5: FIND OUT THE LOWEST AND HIGHEST AMOUNT IN PAYMENTS.
SELECT * FROM payments;
SELECT MAX(amount) AS MAX_AMOUNTS, MIN(amount) AS LEAST_AMOUNTS FROM payments;

-- STEP 6: FINDING OUT THE UNIQUE COUNT of CUSTOMER NAMES.
SELECT * FROM customers;
SELECT COUNT(DISTINCT(customerName))  AS UniqueCustomerCount FROM customers;

-- STEP 8: CREATE A VIEW FROM CUSTOMERS AND PAYMENTS.
SELECT * FROM payments;
SELECT * FROM customers;
...
-- CREATE A STORED PROCEDURE ON PRODUCTS WHICH DISPLAYS THE PRODUCTLINE FOR CLASSIC CARS.
...
-- CREATED A FUNCTION TO GET THE CREDITLIMIT OF CUSTOMERS LESS THAN 96800
SELECT * FROM payments;
